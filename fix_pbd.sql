...
--
-- Host: localhost:3306
-- Generation Time: Apr 10, 2026 at 04:48 PM
...
(7, 4, 4, 100, 5000, 550000),
(8, 4, 6, 100, 1000, 110000),
(9, 4, 1, 100, 100000, 11000000);
...
(4, 5000, 100, 500000, 4, 7),
(5, 1000, 100, 100000, 6, 7),
(6, 100000, 100, 10000000, 1, 7);
...
(22, 'P', 100, 0, 120, '2025-12-18 14:24:20', 7, 4),
(23, 'P', 100, 0, 100, '2025-12-18 14:25:39', 8, 6),
(24, 'P', 100, 0, 100, '2025-12-18 14:25:43', 9, 1);
...
(6, '2025-12-01 11:34:35', 11, 0, 1, '2025-12-01 11:37:19'),
(7, '2025-12-18 14:23:43', 10, 1, 1, '2025-12-18 14:23:43');
...
(7, '2025-12-18 14:23:52', 1, 'N', 7, 10600000, 10, 11660000);
...
(2, '2025-12-18 14:25:57', 0, 11, 0, 1, 7);
...
--
ALTER TABLE `detail_penerimaan`
  MODIFY `iddetail_penerimaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `detail_pengadaan`
--
ALTER TABLE `detail_pengadaan`
  MODIFY `iddetail_pengadaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `kartu_stok`
  MODIFY `idkartu_stok` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `margin_penjualan`
--
ALTER TABLE `margin_penjualan`
  MODIFY `idmargin_penjualan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `satuan`
  MODIFY `idsatuan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `vendor`
  MODIFY `idvendor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
