...
$rows = $MarginPenjualan->ReadQuery();
$alert = '';
    ...
    <div class="row justify-content-center">
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            <h1 class="card-title mb-4">Data Margin Penjualan</h1>
            <?= $alert ?>
            <a href="TambahMarginPenjualan.php" class="btn btn-success mb-3">Tambah Margin Penjualan</a>
            <a href="MarginPenjualanAll.php" class="btn btn-success mb-3">View All</a>
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="HapusMarginPenjualan.php?id=<?= $row['idmargin_penjualan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus margin penjualan ini? jika iya hapus penjualan dan detail penjualan terlebih dahulu jika tidak data tidak akan terhapus dan kartu stok tidak sesuai');">Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
