...
$rows = $Penjualan->ReadQueryPenjualanAll();
$alert = '';
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            ...
            <a href="Penjualan.php" class="btn btn-success mb-3">View</a>
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <!-- <a href="HapusPenjualan.php?id=<?= $row['idpenjualan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus penjualan ini?');">Hapus</a> -->
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
