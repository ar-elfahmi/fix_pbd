      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            ...
            <a href="PengadaanAll.php" class="btn btn-success mb-3">View All</a>
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="HapusPengadaan.php?id=<?= $row['idpengadaan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus pengadaan ini? jika iya hapus detail pengadaan dan penerimaan terlebih dahulu jika tidak data tidak akan terhapus dan kartu stok tidak sesuai');">Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
